...
class UserSettings(Base):
    ...
    theme_accent = Column(String(20), default="cyan", comment="主题色: cyan/violet/amber/emerald/custom")
    theme_accent_custom = Column(String(9), nullable=True, comment="自定义主题色 HEX")
